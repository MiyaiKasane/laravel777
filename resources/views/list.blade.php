...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .hidden{display:none}.items-center{align-items:center}.justify-center{justify-content:center}
            .font-semibold{font-weight:600}.h-5{height:1.25rem}
            .h-8{height:2rem}.h-16{height:4rem}.text-sm{font-size:.875rem}.text-lg{font-size:1.125rem}
            ...
            .mt-8{margin-top:2rem}.ml-12{margin-left:3rem}.-mt-px{margin-top:-1px}.max-w-6xl{max-width:72rem}
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <thead>
                    <tr>
                        ...
                        <th>在庫数</th>
                        <th>メーカー名</th>
                        <th><button class="onclick" onclick="location.href='http://localhost:80/practiceSec/public/'">新規登録</button></th>
                    </tr>
                </thead>
                <tbody>
